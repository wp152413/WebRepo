...
<script>
	...
	<% if("error".equals(request.getAttribute("msg"))) { %>	
		...
		$('#inputEmail').val("<%=request.getParameter("inputEmail")%>")
		$('#inputPassword').val("<%=request.getParameter("inputPassword")%>")
		$('#inputName').val("<%=request.getParameter("inputName")%>")
		$('#inputNickname').val("<%=request.getParameter("inputNickname")%>")
